...
def test_ResultReporter_export_json_file(cwd_mock):
    ...
    open_mock.assert_called_once_with("/my_location/report.json", mode="w")
...
def test_ResultReporter_export_graph_image(plt_mock, cwd_mock):
    cwd_mock.return_value = "/my_location"
    ...
    plt_mock.savefig.assert_called_once_with("/my_location/graph_report")
